...
class Gravatar extends AbstractExtension {
	...
	public function getFilters() {
		if ($this->filterPrefix !== 'gr') {
			return array(
				new TwigFilter($this->filterPrefix . 'Avatar', array($this, 'avatar'), $this->filterOptions),
				new TwigFilter($this->filterPrefix . 'Https', array($this, 'https'), $this->filterOptions),
				new TwigFilter($this->filterPrefix . 'Size', array($this, 'size'), $this->filterOptions),
				new TwigFilter($this->filterPrefix . 'Default', array($this, 'def'), $this->filterOptions),
				new TwigFilter($this->filterPrefix . 'Rating', array($this, 'rating'), $this->filterOptions)
			);
		}

		return array(
			new TwigFilter('grAvatar', array($this, 'avatar'), $this->filterOptions),
			new TwigFilter('grHttps', array($this, 'https'), $this->filterOptions),
			new TwigFilter('grSize', array($this, 'size'), $this->filterOptions),
			new TwigFilter('grDefault', array($this, 'def'), $this->filterOptions),
			new TwigFilter('grRating', array($this, 'rating'), $this->filterOptions)
		);
	}
