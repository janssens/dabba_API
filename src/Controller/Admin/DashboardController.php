...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        yield MenuItem::linkToCrud('Types de restaurant', 'fas fa-pizza-slice', Tag::class);
        if ($this->isGranted('ROLE_SUPER_ADMIN')){
            yield MenuItem::linkToCrud('Types de plat', 'fas fa-clock', MealType::class);
        }
        yield MenuItem::linkToCrud('QR Codes restaurant', 'fas fa-qrcode', CodeRestaurant::class);
